...
public class Userinfo implements Serializable
{
    ...
    @Column(name="US_COUNTRY", nullable=false)
    private int        usCountry    ;
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="userinfo", targetEntity=Command.class)
    ...
    //--- DATABASE MAPPING : US_COUNTRY ( INTEGER ) 
    public void setUsCountry( int usCountry )
    {
        this.usCountry = usCountry;
    }
    public int getUsCountry()
    {
        return this.usCountry;
    }
